      ...
      <div className="w-full p-8 flex items-center justify-center">
        <div className="p-4 flex flex-col gap-4 items-center justify-center md:w-[50rem]">
          <div className="flex items-center gap-2">
            ...
            <span className="font-sans text-gray-700 text-center font-medium text-sm md:text-lg">
              Sign up for our weekly email newsletter
            </span>
          </div>
          <div className="text-center text-xs font-normal text-gray-600 font-sans md:text-sm lg:w-[70%]">
